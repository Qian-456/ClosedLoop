...
def build_plan_sub_candidate_urls(configured_url: str, target_path: str) -> list[str]:
    ...
    raw_bases = [
        _extract_plan_sub_base_url(configured_url),
...
def request_plan_sub_json(
    ...
    candidate_urls = build_plan_sub_candidate_urls(configured_url, target_path)
